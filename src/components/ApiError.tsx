...
export default function ApiError() {
  return (
    <div className="flex flex-col w-full justify-center items-center mt-8 md:mt-16 pt-10 gap-6">
      <Image src="/assets/icon-error.svg" alt="Error" width={42} height={50} />
      <h3 className="text-[52px] text-center font-bricolage-grotesque font-bold">
        Something went wrong
      </h3>
      <p className="text-xl text-neutral-200 md:w-[554px] text-center">
